...
`{r left_join} adsl_mrg_cnt <- small_n_cnt %>%   left_join(Big_N_cnt) adsl_mrg_cnt`
...
`{r mutate_and_round} adsl_mrg_cnt %>%   mutate(perc = round((n/N)*100, digits=1))`
